...
- Flow: nós, arestas, controles e minimapa para processos e diagramas (`@lexui/flow`), incluindo arestas animadas e nó ativo para monitores em tempo real (patterns/live-activity.md)
