...
export const catalogComponents: CatalogComponent[] = [
  ...
  { name: "Flow", slug: "flow", category: "Estrutura", description: "Fluxos e diagramas com nós, arestas, controles e minimapa, tematizados por tokens.", usage: "import { Flow, FlowBackground, FlowControls, FlowMiniMap, flowNodeTypes } from \"@lexui/flow\"", interactive: true },
