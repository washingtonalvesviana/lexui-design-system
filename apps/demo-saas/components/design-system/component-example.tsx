...
export function ComponentExample({ slug }: { slug: string }) {
  ...
  switch (slug) {
    ...
    case "tabs": return <ExampleFrame title="Painéis relacionados"><Tabs defaultValue="overview"><TabsList><TabsTrigger value="overview" count={4}>Visão geral</TabsTrigger><TabsTrigger value="security" count={2}>Segurança</TabsTrigger><TabsTrigger value="billing" count={1202}>Cobrança</TabsTrigger><TabsTrigger value="logs">Logs</TabsTrigger></TabsList><TabsContent value="overview"><div className="demo-tab-panel">Dados gerais da organização.</div></TabsContent><TabsContent value="security"><div className="demo-tab-panel">Políticas de senha e autenticação.</div></TabsContent><TabsContent value="billing"><div className="demo-tab-panel">Plano, pagamento e faturas.</div></TabsContent><TabsContent value="logs"><div className="demo-tab-panel">Eventos de auditoria da organização.</div></TabsContent></Tabs></ExampleFrame>
